...
<template>
  <div class="inline-block">
    <svg
      viewBox="0 0 800 240"
      class="w-[75px] h-auto align-top transition-transform duration-300 ease-in-out hover:scale-110"
    >
      <g fill="currentColor">
        <path
